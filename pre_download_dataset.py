...
datasets_to_download = [
    ...
    # === Perplexity: Pile (22 configs) ===
    ('EleutherAI/pile', 'pile_arxiv'),
    ('EleutherAI/pile', 'pile_bookcorpus2'),
    ('EleutherAI/pile', 'pile_books3'),
    ('EleutherAI/pile', 'pile_dm-mathematics'),
    ('EleutherAI/pile', 'pile_enron'),
    ('EleutherAI/pile', 'pile_europarl'),
    ('EleutherAI/pile', 'pile_freelaw'),
    ('EleutherAI/pile', 'pile_github'),
    ('EleutherAI/pile', 'pile_gutenberg'),
    ('EleutherAI/pile', 'pile_hackernews'),
    ('EleutherAI/pile', 'pile_nih-exporter'),
    ('EleutherAI/pile', 'pile_opensubtitles'),
    ('EleutherAI/pile', 'pile_openwebtext2'),
    ('EleutherAI/pile', 'pile_philpapers'),
    ('EleutherAI/pile', 'pile_pile-cc'),
    ('EleutherAI/pile', 'pile_pubmed-abstracts'),
    ('EleutherAI/pile', 'pile_pubmed-central'),
    ('EleutherAI/pile', 'pile_stackexchange'),
    ('EleutherAI/pile', 'pile_ubuntu-irc'),
    ('EleutherAI/pile', 'pile_uspto'),
    ('EleutherAI/pile', 'pile_wikipedia'),
    ('EleutherAI/pile', 'pile_youtubesubtitles'),
